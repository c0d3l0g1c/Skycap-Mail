namespace Skycap.Net.Imap.Commands
{
    ...
    internal class SUBSCRIBECommand : IMAP4BaseCommand
    {
        protected string _mailbox;
        protected const string SubscribePattern = "SUBSCRIBE \"{0}\"";
        ...
        {
            uint commandId = base._dispatcher.SendCommand(string.Format("SUBSCRIBE \"{0}\"", this._mailbox));
